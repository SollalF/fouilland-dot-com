...
export default function Page() {
  return (
    <DirectionalTransition>
      <main
        id="main-content"
        className="flex flex-col min-h-[100dvh] space-y-10 bg-background font-sans antialiased max-w-2xl mx-auto py-12 sm:py-24 px-6 pb-[calc(5rem+env(safe-area-inset-bottom))]"
      >
        <section id="hero">
          <div className="mx-auto w-full max-w-2xl space-y-8">
            <div className="gap-2 flex justify-between">
              ...
              <BlurFade delay={BLUR_FADE_DELAY}>
                <Avatar className="size-28 border-2 border-primary ring-2 ring-primary/20">
        ...
        <section id="about">
          <BlurFade delay={BLUR_FADE_DELAY * 3}>
            <h2 className="text-xl font-bold">
              <span className="border-l-4 border-primary pl-3">About</span>
            </h2>
          </BlurFade>
